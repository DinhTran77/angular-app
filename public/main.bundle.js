...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__data_position_service__ = __webpack_require__("./src/app/data/position.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__data_employee_service__ = __webpack_require__("./src/app/data/employee.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__employee_employee_component__ = __webpack_require__("./src/app/employee/employee.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__position_position_component__ = __webpack_require__("./src/app/position/position.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__positions_positions_component__["a" /* PositionsComponent */],
                __WEBPACK_IMPORTED_MODULE_12__page_not_found_page_not_found_component__["a" /* PageNotFoundComponent */],
                __WEBPACK_IMPORTED_MODULE_15__employee_employee_component__["a" /* EmployeeComponent */],
                __WEBPACK_IMPORTED_MODULE_16__position_position_component__["a" /* PositionComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_13__data_position_service__["a" /* PositionService */], __WEBPACK_IMPORTED_MODULE_14__data_employee_service__["a" /* EmployeeService */]],
...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.saveEmployee = function (employee) {
        return this.http.put("https://warm-ocean-35680.herokuapp.com/employee/" + employee._id, employee);
    };
    EmployeeService.prototype.getEmployee = function (id) {
        return this.http.get("https://warm-ocean-35680.herokuapp.com/employee-raw/" + id);
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmployeeRaw; });
...
var PositionService = /** @class */ (function () {
    ...
    PositionService.prototype.savePosition = function (position) {
        return this.http.put("https://warm-ocean-35680.herokuapp.com/position/" + position._id, position);
    };
    PositionService.prototype.getPosition = function (id) {
        return this.http.get("https://warm-ocean-35680.herokuapp.com/position/" + id);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_employeeRaw__ = __webpack_require__("./src/app/data/employeeRaw.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_position_service__ = __webpack_require__("./src/app/data/position.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(employeeService, route, positionService) {
        this.employeeService = employeeService;
        this.route = route;
        this.positionService = positionService;
        this.employee = new __WEBPACK_IMPORTED_MODULE_1__data_employeeRaw__["a" /* EmployeeRaw */];
    ...
    EmployeeComponent.prototype.ngOnInit = function () {
        ...
        this.paramSubscription = this.route.params.subscribe(function (params) {
            ...
            _this.employeeSubscription = _this.employeeService.getEmployee(params['_id']).subscribe(function (emp) {
                ...
                _this.getPositionSubscription = _this.positionService.getPositions().subscribe(function (data) {
    ...
    EmployeeComponent.prototype.onSubmit = function () {
        var _this = this;
        this.saveEmployeeSubscription = this.employeeService.saveEmployee(this.employee).subscribe(function (emp) {
    ...
    EmployeeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__data_employee_service__["a" /* EmployeeService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_4__data_position_service__["a" /* PositionService */]])
    ], EmployeeComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_vm_typicode__ = __webpack_require__("./src/app/data/vm-typicode.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PositionComponent = /** @class */ (function () {
    function PositionComponent(route, router, positionService) {
        ...
        this.router = router;
        this.positionService = positionService;
        this.position = new __WEBPACK_IMPORTED_MODULE_3__data_vm_typicode__["a" /* Position */];
        this.successMessage = false;
        this.failMessage = false;
    }
    PositionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.paramSubscription = this.route.params.subscribe(function (params) {
            _this.positionSubscription = _this.positionService.getPosition(params['_id']).subscribe(function (positions) {
    ...
    PositionComponent.prototype.onSubmit = function (f) {
        var _this = this;
        this.savePositionSubscription = this.positionService.savePosition(this.position).subscribe(function (pos) {
            _this.successMessage = true;
            setTimeout(function () { _this.successMessage = false; }, 2500);
        }, function (error) {
            _this.failMessage = true;
    ...
    PositionComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_1__data_position_service__["a" /* PositionService */]])
    ], PositionComponent);
